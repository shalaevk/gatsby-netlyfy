...
import decoimg from "../../images/decor-img.png"
import decoimg2 from "../../images/jap-vinn.png"
  ...
  return (<PrimaryLayout
      ...
      <section id='tech' className="container-fluid video-section">
        <div className="title-wrap pt-6 text-center ">
          ...
          <div className="description col-xl-5 col-lg-7 m-auto"
               dangerouslySetInnerHTML={{ __html: data.wpPage.acField.sectionDescription }}/>
        </div>
        ...
        <div className="video-wrap d-flex justify-content-center">
          ...
          <div className="video-left-wrap descktop-block  d-flex justify-content-end">
            <div className="video-text">
              ...
              <div className="description left-video-description"
                   dangerouslySetInnerHTML={{ __html: data.wpPage.acField.videodescription }}/>
          ...
          <div className="video-right-wrap d-flex">
            <div className="video-text">
              <div className="left-video-title"
                   dangerouslySetInnerHTML={{ __html: data.wpPage.acField.secondVideoTitle }}/>
              <span onClick={() => {
                showModal()
                setId(2)
              }}>
            ...
            <div className="description right-video-description"
                 dangerouslySetInnerHTML={{ __html: data.wpPage.acField.secondVideoDescription }}/>
          </div>
      ...
      <section id='gall' className="gallery container-fluid">
        ...
        <div className="gallery-desc col-xl-5 col-lg-7 m-auto text-center"
             dangerouslySetInnerHTML={{ __html: data.wpPage.acField.galleryDescription }}/>
        <div className="card-co">
          {imagesMap}
        </div>

        <div id='concept' className="styling d-flex justify-content-center"
             style={bgFunction(data.wpPage.acField.stylingIng.sourceUrl)}>
          <div className="styling-text d-flex justify-content-center">
            <div className="styling-title text-center"
                 dangerouslySetInnerHTML={{ __html: data.wpPage.acField.stilyngTitle }}/>
            <span onClick={() => {
              showModal()
              setId(5)
            }}>
